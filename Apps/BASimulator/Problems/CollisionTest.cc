...
//  
//  AddOption("testtoexecute", "which test to execute", (int)0);
//}
//
//CollisionTest::~CollisionTest()
//{
...
//{  
//
//  switch (GetIntOpt("testtoexecute")) 
//  {
//    case 0:
//    {
//      std::cout << "\033[35;1mCOLLISIONTEST MESSAGE:\033[m Executing test number " << GetIntOpt("testtoexecute") << ", genTorusPull()." << std::endl;
//      genTorusPull();
//      break;
//    }
//    case 1:
//    {
//      std::cout << "\033[35;1mCOLLISIONTEST MESSAGE:\033[m Executing test number " << GetIntOpt("testtoexecute") << ", genTorusTest()." << std::endl;
//      genTorusTest();
//      break;
//    }
//    case 2:
//    {
//      std::cout << "\033[35;1mCOLLISIONTEST MESSAGE:\033[m Executing test number " << GetIntOpt("testtoexecute") << ", genNullTest()." << std::endl;
//      genNullTest();
//      break;
//    }
//    case 3:
//    {
//      std::cout << "\033[35;1mCOLLISIONTEST MESSAGE:\033[m Executing test number " << GetIntOpt("testtoexecute") << ", genRodRodPenaltyBasic00()." << std::endl;
//      genRodRodPenaltyBasic00();
//      break;
//    }
//    default:
//    {
//      std::cerr << "\033[31;1mERROR IN COLLISIONTEST:\033[m Invalid value for \"testtoexecute\" specified. Exiting. " << std::endl;
//      exit(1);
//      break;
//    }
//  }
...
//  if( getTime() > 50.0 ) 
//  {
//    std::cout << "Completed simulation, exiting." << std::endl;
//    exit(0);
//  }
//}
//
...
//
//// Two perependicular segments collide
