...
#include <cassert>
#include "ElTopo/common/lapack_wrapper.h"
#include "ElTopo/common/runstats.h"
#include "ElTopo/eltopo3d/meshsmoother.h"
...
double FaceOffMultiDriver::signed_distance_entropy(const Vec3d& x,
                                                   const Vec3d& a,
                                                   const Vec3d& b,
                                                   double max_radius,
