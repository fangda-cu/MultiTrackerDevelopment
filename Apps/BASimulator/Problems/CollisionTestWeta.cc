...
bool RodObjSnaggingController::execute()
{
  ...
  {  
   ...
   // std::cout << "rod vertex 19  position "<< m_rod.getVertex(19)<< std::endl;
    ...
    float v0_0= roundto( (float)test0(0), 10000.0f );
    float v0_1= roundto( (float)test0(1), 10000.0f );
    float v0_2= roundto( (float)test0(2), 10000.0f );
    float v1_0= roundto( (float) test1(0), 10000.0f );
    float v1_1= roundto( (float)test1(1), 10000.0f );
    float v1_2= roundto( (float)test1(2), 10000.0f );
    float v10_0= roundto( (float)test10(0), 10000.0f );
    float v10_1= roundto( (float)test10(1), 10000.0f );
    float v10_2= roundto( (float)test10(2), 10000.0f );
    float v19_0= roundto( (float)test19(0), 10000.0f );
    float v19_1= roundto( (float)test19(1), 10000.0f );
    float v19_2= roundto( (float)test19(2), 10000.0f );
    float v39_0= roundto( (float)test39(0), 10000.0f );
    float v39_1= roundto( (float)test39(1), 10000.0f );
    float v39_2= roundto( (float)test39(2), 10000.0f );
...
float  RodObjSnaggingController::roundto(float val, float prec) { return floor( prec * val + 0.5f ) / prec; }
...
bool ObjTranslatorWeta::execute()
{
  ...
  {  
   ...
   // std::cout << "rod vertex 19  position "<< m_rod.getVertex(19)<< std::endl;
    //fprintf(m_pFile, "this is a test");
    float v0_0= roundto( (float)test0(0), 10000.0 );
    float v0_1= roundto( (float)test0(1), 10000.0 );
    float v0_2= roundto( (float)test0(2), 10000.0 );
    float v1_0= roundto( (float)test1(0), 10000.0 );
    float v1_1= roundto( (float)test1(1), 10000.0 );
    float v1_2= roundto( (float)test1(2), 10000.0 );
    float v10_0= roundto( (float)test10(0), 10000.0 );
    float v10_1= roundto( (float)test10(1), 10000.0 );
    float v10_2= roundto( (float)test10(2), 10000.0 );
    float v19_0= roundto( (float)test19(0), 10000.0 );
    float v19_1= roundto( (float)test19(1), 10000.0 );
    float v19_2= roundto( (float)test19(2), 10000.0 );
    float v39_0= roundto( (float)test39(0), 10000.0 );
    float v39_1= roundto( (float)test39(1), 10000.0 );
    float v39_2= roundto( (float)test39(2), 10000.0 );
    fprintf(m_pFile, "%9.4f %9.4f %9.4f\n",  v0_0, v0_1, v0_2);
    fprintf(m_pFile, "%9.4f %9.4f %9.4f\n",  v1_0, v1_1, v1_2);
    fprintf(m_pFile, "%9.4f %9.4f %9.4f\n", v10_0, v10_1, v10_2);
    fprintf(m_pFile, "%9.4f %9.4f %9.4f\n", v19_0, v19_1, v19_2);
...
float  ObjTranslatorWeta::roundto(float val, float prec) { return floor( prec * val + 0.5f ) / prec; }
