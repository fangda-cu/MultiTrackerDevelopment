...
bool RodObjSnaggingController::execute()
{
  ...
  {  
   ...
   // std::cout << "rod vertex 19  position "<< m_rod.getVertex(19)<< std::endl;
    ...
    float v0_0= roundto( test0(0), 10000.0f );
    float v0_1= roundto( test0(1), 10000.0f );
    float v0_2= roundto( test0(2), 10000.0f );
    float v1_0= roundto( test1(0), 10000.0f );
    float v1_1= roundto( test1(1), 10000.0f );
    float v1_2= roundto( test1(2), 10000.0f );
    float v10_0= roundto( test10(0), 10000.0f );
    float v10_1= roundto( test10(1), 10000.0f );
    float v10_2= roundto( test10(2), 10000.0f );
    float v19_0= roundto( test19(0), 10000.0f );
    float v19_1= roundto( test19(1), 10000.0f );
    float v19_2= roundto( test19(2), 10000.0f );
    float v39_0= roundto( test39(0), 10000.0f );
    float v39_1= roundto( test39(1), 10000.0f );
    float v39_2= roundto( test39(2), 10000.0f );
