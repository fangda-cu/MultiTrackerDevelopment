                      ...
                      const char *filename_format, ...)
{
    ...
    for ( unsigned int t = 0; t < ntris; ++t )
    {
        ...
        mesh.nondestructive_add_triangle( Vec3st(tri), Vec2i(0,1) );
    }
                                      ...
                                      const char *filename_format, ...)
{
    ...
    for ( unsigned int t = 0; t < ntris; ++t )
    {
        ...
        infile >> tri[1];
        infile >> tri[2];
        mesh.nondestructive_add_triangle(tri, Vec2i(0,1));
    }
            ...
            case 'f': // face data
                if(line[1]==' '){
                    ...
                    for(int j=0; j<(int)vertex_list.size()-2; ++j)
                        mesh.nondestructive_add_triangle( Vec3st(vertex_list[0], vertex_list[j+1], vertex_list[j+2]), Vec2i(0,1) );
                }
                break;
        }
    }
