                   ...
                   size_t nx )
{
    ...
    {
        temp_tri_mesh.nondestructive_add_triangle( tris[i], Vec2i(0,1) );
    }
                               ...
                               double handle_width )
{
    ...
    for ( size_t i = 0; i < verts.size(); ++i )
    {
        ...
        assert( std::fabs( signed_distance_dumbbell( pt, sphere_a_centre, sphere_b_centre, sphere_radius, handle_width )) < 1e-8 ); 
    }
