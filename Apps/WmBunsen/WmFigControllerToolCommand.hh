#ifndef _WMFIGCONTROLLERTOOLCOMMAND_HH_
#define _WMFIGCONTROLLERTOOLCOMMAND_HH_
...
class WmFigControllerToolCommand : public MPxToolCommand
{
public:

    WmFigControllerToolCommand();
    virtual ~WmFigControllerToolCommand();
