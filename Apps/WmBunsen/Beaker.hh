...
public:
    ...
    void takeTimeStep(
            ...
            int i_fullSelfCollisionIters, double i_selfCollisionCOR, FixedRodVertexMap* i_fixedVertices = NULL,
            bool i_zeroAllTwist = false, double i_constraintSrength = 10.0, LockedRodVertexMap* i_lockedRodVertexMap = NULL);
    ...
    void addRodsToWorld(int i_rodGroupIndex, WmFigRodGroup* i_rodGroup, double startTime, int numberOfThreads, const PerformanceTuningParameters perf_param);
