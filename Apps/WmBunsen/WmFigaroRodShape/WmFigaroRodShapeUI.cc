...
WmFigaroRodShapeUI::WmFigaroRodShapeUI() {}
WmFigaroRodShapeUI::~WmFigaroRodShapeUI() {}

void* WmFigaroRodShapeUI::creator()
{
	return new WmFigaroRodShapeUI();
}
...
/* override */
void WmFigaroRodShapeUI::getDrawRequests( const MDrawInfo & info,
...
/* override */
void WmFigaroRodShapeUI::draw( const MDrawRequest & request, M3dView & view ) const
//
// Description:
//
...
/* override */
bool WmFigaroRodShapeUI::select( MSelectInfo &selectInfo, MSelectionList &selectionList,
...
void WmFigaroRodShapeUI::drawVertices( const MDrawRequest & request,
							  M3dView & view ) const
//
// Description:
//
