...
bool WmSweeneyRodManager::addRod(const std::vector<BASim::Vec3d>& i_vertices, const double i_time,
        const BASim::Vec3d& i_referenceDir1, const double i_youngsModulus, const double i_shearModulus,
        const double i_viscosity, const double i_density, const double i_radiusA, const double i_radiusB,
        const BASim::ElasticRod::RefFrameType i_referenceFrame, const double i_massDamping, const BASim::Vec3d i_gravity,
...
void WmSweeneyRodManager::addCollisionMesh(BASim::TriangleMesh* i_triangleMesh, BASim::LevelSet* i_levelSet,
        ...
        int i_numLineSearchIters)
{
    ...
    std::cout << "Max Num Collision Iterations  " << perfParams.m_collision.m_max_iterations << std::endl;
    ...
    std::cout << "Max Number of Solver Substeps " << perfParams.m_solver.m_max_substeps << std::endl;
    std::cout << "Collison Failure  " << perfParams.m_collision.m_in_case_of << std::endl;
    std::cout << "Max Number of Collision Substeps " << perfParams.m_collision.m_max_substeps << std::endl;
    std::cout << "Explosion  Failure  " << perfParams.m_explosion.m_in_case_of << std::endl;
    std::cout << "Max Number of Explosion Substeps " << perfParams.m_explosion.m_in_case_of << std::endl;
...
void WmSweeneyRodManager::updateSolverSettings(double i_atol, double i_stol, double i_rtol, double i_inftol,
        int i_numLineSearchIters, double i_penaltyStiffness)
{
