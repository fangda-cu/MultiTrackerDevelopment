...
WmSweeneyShapeUI::WmSweeneyShapeUI() {}
WmSweeneyShapeUI::~WmSweeneyShapeUI() {}

void* WmSweeneyShapeUI::creator()
{
	return new WmSweeneyShapeUI();
}
...
/* override */
void WmSweeneyShapeUI::getDrawRequests( const MDrawInfo & info,
...
//
{
	...
	//
	MDrawData data;
	WmSweeneyShape* shape = (WmSweeneyShape*) surfaceShape();
...
/* override */
void WmSweeneyShapeUI::draw( const MDrawRequest & request, M3dView & view ) const
//
// Description:
//
...
/* override */
bool WmSweeneyShapeUI::select( MSelectInfo &selectInfo, MSelectionList &selectionList,
...
void WmSweeneyShapeUI::drawVertices( const MDrawRequest & request,
							  M3dView & view ) const
//
// Description:
//
...
bool WmSweeneyShapeUI::selectVertices( MSelectInfo &selectInfo,
