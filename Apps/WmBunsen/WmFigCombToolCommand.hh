#ifndef _WMFIGCOMBTOOLCOMMAND_HH_
#define _WMFIGCOMBTOOLCOMMAND_HH_
...
class WmFigCombToolCommand : public MPxToolCommand
{
public:

    WmFigCombToolCommand();
    virtual ~WmFigCombToolCommand();
