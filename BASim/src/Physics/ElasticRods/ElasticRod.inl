...
inline void ElasticRod::setReferenceDirector1(const edge_handle& eh, const Vec3d& u)
{
    property(m_referenceDirectors)[eh].first = u;
}

inline const Vec3d& ElasticRod::getReferenceDirector2(const edge_handle& eh) const
{
    return property(m_referenceDirectors)[eh].second;
}

inline void ElasticRod::setReferenceDirector2(const edge_handle& eh, const Vec3d& v)
{
...
{
    assert(property_exists(m_YoungsModulus, "Young's modulus"));
...
inline void ElasticRod::setReferenceTwist(const vertex_handle& vh, const Scalar& referenceTwist)
{
...
inline void ElasticRod::setCurvatureBinormal(const vertex_handle& vh, const Vec3d& kb)
{
