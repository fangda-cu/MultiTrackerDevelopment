...
//      Scalar viscous_stiffness;
      ...
      // cached properties
      Vec3d AP;  // normalized shell axis AP in rod's material frame (P = (B+C)/2)
      Scalar delta;  // shell's rotation about AP
    };
  ...
  protected:
    ...
    adreal<NumDof, DO_HESS, Scalar> adEnergy(const RodShellVertexJointCouplingForce & mn, const Vec3d & A, const Vec3d & B, const Vec3d & C, const Vec3d & D, Scalar delta, Scalar theta, const Vec3d & ref1, const Vec3d & ref2, const Vec3d & undeformed_AP, Scalar undeformed_delta, Scalar stiffness);
