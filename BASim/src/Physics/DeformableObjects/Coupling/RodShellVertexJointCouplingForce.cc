...
RodShellVertexJointCouplingForce::adEnergy(const RodShellVertexJointCouplingForce & mn, const Vec3d & A, const Vec3d & B, const Vec3d & C, const Vec3d & D, Scalar theta, const Vec3d & ref1, const Vec3d & ref2, const Vec3d & undeformed_AP, Scalar stiffness) 
{  
...
Scalar RodShellVertexJointCouplingForce::localEnergy(Stencil & s, bool viscous)
{
  ...
  adreal<NumDof, 1, Scalar> e = adEnergy<1>(*this, A, B, C, D, theta, ref1, ref2, (viscous ? s.damping_undeformed_AP : s.undeformed_AP), (viscous ? m_stiffness_damp : m_stiffness));
