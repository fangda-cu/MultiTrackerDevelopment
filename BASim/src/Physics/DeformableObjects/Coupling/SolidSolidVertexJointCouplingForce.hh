...
//      Scalar viscous_stiffness;
      ...
      // cached properties
      Vec3d AP;      // t1 axis AP in t2 frame (P = (B+C+D)/2)
      Scalar delta;  // t1 rotation about AP
    };
  ...
  protected:
    ...
    adreal<NumDof, DO_HESS, Scalar> adEnergy(const SolidSolidVertexJointCouplingForce & mn, const Vec3d & A, const Vec3d & B, const Vec3d & C, const Vec3d & D, const Vec3d & E, const Vec3d & F, const Vec3d & G, Scalar delta, const Vec3d & undeformed_AP, Scalar undeformed_delta, Scalar stiffness);
