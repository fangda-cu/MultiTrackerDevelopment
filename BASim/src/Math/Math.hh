...
inline void minmax(const Vec3d &x0, const Vec3d &x1, Vec3d &xmin, Vec3d &xmax)
{
...
inline void minmax(const Vec3d &x0, const Vec3d &x1, const Vec3d &x2, const Vec3d &x3, Vec3d &xmin, Vec3d &xmax)
{
    for(unsigned int i=0; i<3; ++i)
    {
        xmin[i] = std::min(x0[i],
...
inline void minmax(const Vec3d &x0, const Vec3d &x1, const Vec3d &x2, const Vec3d &x3, const Vec3d &x4,
                   const Vec3d &x5, Vec3d &xmin, Vec3d &xmax)
{
    for(unsigned int i=0; i<3; ++i)
    {
        xmin[i] = std::min(x0[i],
...
inline void update_minmax(const Vec3d &x, Vec3d &xmin, Vec3d &xmax)
{
    for(unsigned int i=0; i<3; ++i)
    {
        if (x[i] < xmin[i])
