...
setenv MAYA_PLUG_IN_PATH ./Apps/WmBunsen/:${MAYA_PLUG_IN_PATH}
setenv MAYA_SCRIPT_PATH ../Apps/WmBunsen/:${MAYA_SCRIPT_PATH}
setenv XBMLANGPATH ../Apps/WmBunsen/icons/%B:${XBMLANGPATH}
