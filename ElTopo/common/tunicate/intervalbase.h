...
public:
    ...
    inline virtual ElTopo::Vec2d get_actual_interval() const;
    inline virtual ElTopo::Vec2d get_internal_representation() const;
...
inline ElTopo::Vec2d IntervalBase::get_actual_interval() const
{
    return ElTopo::Vec2d( -stored_left(), stored_right() );
}

// ----------------------------------------

inline ElTopo::Vec2d IntervalBase::get_internal_representation() const
{
    return ElTopo::Vec2d( stored_left(), stored_right() );
}
